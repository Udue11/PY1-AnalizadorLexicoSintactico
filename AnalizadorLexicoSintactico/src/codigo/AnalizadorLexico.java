...
public class AnalizadorLexico {
    public static void main(String[] args) {
        String ruta = "..//AnalizadorLexicoSintactico/src/codigo/lexer.flex";
        GenerarLexer(ruta);
        String rutap = "C:/Users/Froylan Lara Oses/Desktop/aarchivoP.txt";
        AnalizarDoc(rutap);
    }
    public static void GenerarLexer(String ruta){
        //ClearFile("..//AnalizadorLexicoSintactico/src/codigo/lexer.java");
    ...
    public static void AnalizarDoc(String ruta) {
        try {
            ...
            while (true) {     
                ...
                System.out.println("token:      "+tokens +"             lexema:     "+lexer.lexeme);
